...
<link rel="stylesheet" href="{{ asset('root/resources/assets/vendor/magnific-popup/magnific-popup.css') }}"/>
...
<!-- Head Libs -->
<script src="{{ asset('root/resources/assets/vendor/modernizr/modernizr.js') }}"></script>
<!-- Vendor -->
